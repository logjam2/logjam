...
namespace LogJam.Config.Initializer
{
	...
	/// </summary>
	/// <remarks>
	/// Each log writer initializer should implement one or more of <see cref="ILogWriterPipelineInitializer"/> and
	/// <see cref="IImportInitializer"/>.  Initializers are called in this order:
	/// <list type="number">
	/// <item><term><see cref="ILogWriterPipelineInitializer"/></term>
