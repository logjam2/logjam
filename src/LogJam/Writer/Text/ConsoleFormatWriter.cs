...
namespace LogJam.Writer.Text
{
    ...
    public sealed class ConsoleFormatWriter : TextWriterFormatWriter, IStartable
    {
        ...
        public ConsoleFormatWriter(ITracerFactory setupTracerFactory, IConsoleColorResolver colorResolver, string fieldDelimiter = DefaultFieldDelimiter, int spacesPerIndentLevel = 4)
