...
namespace LogJam.Writer
{
	...
	/// </summary>
	/// <seealso cref="ProxyEntryWriter{TEntry}"/> for a similar logwriter that writes each entry to a single <see cref="IEntryWriter{TEntry}"/> instance.
		...
		where TEntry : ILogEntry
	{
		...
		/// forwards to.
		/// </summary>
		public IEnumerable<IEntryWriter<TEntry>> InnerEntryWriters
		{
			get { return _innerEntryWriters; }
		}
