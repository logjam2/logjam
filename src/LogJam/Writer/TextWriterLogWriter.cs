...
namespace LogJam.Writer
{
    ...
    public class TextWriterLogWriter : TextLogWriter, IBufferingLogWriter
    {
        ...
        /// Whether to dispose <paramref name="textWriter" /> when the <c>TextWriterLogWriter</c> is
        /// disposed.
        /// </param>
        /// <param name="flushPredicate">
        /// A function that is used to determine whether to flush the buffers or not.  If <c>null</c>,
        /// a predicate is used to cause buffers to be flushed after every write.
        /// </param>
