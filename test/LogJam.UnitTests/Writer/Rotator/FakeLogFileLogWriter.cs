...
namespace LogJam.UnitTests.Writer.Rotator
{
		...
		where TEntry : ILogEntry
	{
		...
		public FakeLogFileLogWriter(ITracerFactory setupTracerFactory, FileInfo logFile)
		...
		public class Config : LogWriterConfig, ILogFileWriterConfig
		{
			...
			{
				var logWriter = new FakeLogFileLogWriter<TEntry>(setupTracerFactory, new FileInfo(Path.Combine(Directory, File)));
